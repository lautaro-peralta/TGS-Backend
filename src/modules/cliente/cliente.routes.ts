...
clienteRouter.get('/:dni', clienteController.getOneClienteByDni);

clienteRouter.post(
  '/',
  validarConSchema({ body: crearClienteSchema }),
  clienteController.createCliente
);

clienteRouter.patch(
  '/:dni',
  validarConSchema({ body: actualizarClienteSchema }),
  clienteController.patchUpdateCliente
);

clienteRouter.delete('/:dni', clienteController.deleteCliente);
